...
{
    uint32_t ellapsed_time = micros() - timer;
    timer = micros();
    uint32_t ellapsed_count = count - lastCount;
    lastCount = count;
    lastSpeed = speed;
    speed = (1000000.0*ellapsed_count)/((double)ellapsed_time);
    return speed;
...
Encoder4Mot::Encoder4Mot()
{
    ...
    encoders.push_back(new Encoder(PC_2,PC_3,motorPlacement::FD,false));
    encoders.push_back(new Encoder(PH_0,PH_1,motorPlacement::FG,false));
    encoders.push_back(new Encoder(PC_13,PC_14,motorPlacement::BD,false));
    encoders.push_back(new Encoder(PA_13,PA_14,motorPlacement::BG,false));
